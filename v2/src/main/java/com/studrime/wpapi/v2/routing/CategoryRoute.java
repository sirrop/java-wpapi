...
public class CategoryRoute extends RouteBase implements GettableRoute<Term>, PostableRoute<Void>, DeletableRoute<Void> {
    public CategoryRoute(String path, HttpClient client) {
        super(path, client);
    }
