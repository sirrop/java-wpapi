...
public class CategoriesRoute extends RouteBase implements GettableRoute<List<Term>>, PostableRoute<Void> {
    public CategoriesRoute(String path, HttpClient client) {
        super(path, client);
    }
